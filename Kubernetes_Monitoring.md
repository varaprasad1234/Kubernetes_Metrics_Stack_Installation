Kubernetes Observability Platform Lab

Git-friendly Markdown version of the supplied lab instructions.

Components: Local Path Provisioner, SeaweedFS, Grafana, Prometheus Stack, and Loki.
...
When using vim, to paste in the YAML contents while maintaining the required spacing, first issue  paste. Do this later in the lab when needed as well.
